...
use anchor_spl::token_2022::{CloseAccount, ID as TOKEN_PROGRAM_2022_ID, close_account};
use anchor_spl::token_interface::{TransferChecked, transfer_checked};

use crate::error::TemplateError;
use crate::instructions::venues::{deriverse, raydium_amm};
use crate::state::{MAX_MINTS, MAX_SWAPS, SwapSpecInputV2, TitanPda, Venue};
...
fn perform_cpi_swap<'info>(
    ...
    let instructions = match swap.venue {
        ...
        Venue::Deriverse {
            instr_id,
            input_crncy,
        } => deriverse::swap(instr_id, input_crncy, amount, account_metas)?,
    };
