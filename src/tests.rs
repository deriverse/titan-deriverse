...
pub mod tests {
    ...
    pub mod rpc_tests {
        ...
        static CLIENT_A: Lazy<Keypair> = Lazy::new(|| {
            Keypair::read_from_file("../keys/jupiter-devnet/jupiter-client-a.json").unwrap()
        });
        static CLIENT_B: Lazy<Keypair> = Lazy::new(|| {
            Keypair::read_from_file("../keys/jupiter-devnet/jupiter-client-b.json").unwrap()
        });
