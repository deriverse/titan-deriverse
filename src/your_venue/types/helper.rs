...
use crate::your_venue::{
    DRV_PROGRAM_ID, VERSION,
    types::{
        Version,
        constants::{DRVS_SEED, account_type},
    },
};
...
impl Helper for Pubkey {
    fn get_drv_auth() -> Pubkey {
        Self::find_program_address(&[DRVS_SEED], &DRV_PROGRAM_ID).0
    }

    fn new_spot_acc(tag: u32, asset_token_id: u32, crncy_token_id: u32) -> Pubkey {
        let program_id = DRV_PROGRAM_ID;
